...
autocmd BufReadPost,FileReadPost   .auth.aes set foldenable
autocmd BufReadPost,FileReadPost   .auth.aes set foldnestmax=1
...
autocmd BufReadPost,FileReadPost   .auth.aes set nonu
